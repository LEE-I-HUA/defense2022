...
dash_table_columns = []
#table_data = pd.DataFrame(columns=['Date', 'id', 'Recent'])
...
app.layout = html.Div(children=[
    ...
    html.Div([
            ...
            dbc.Label("選擇關鍵字",style=bold_orange
                ),
            ## 選擇中心詞下拉式選單
            dcc.Dropdown(
            ...
            dbc.Label("網路篩選遮罩", style=bold_orange),
            ## 網路篩選遮罩下拉式選單
            dcc.Dropdown(
            ...
            html.H6('針對網路圖的節點類別可以進行篩選', style=annotation),
            
            dbc.Label("設定網路節點數量", style=inline_orange),
            # 網路圖節點數數量下拉式選單
            dcc.Dropdown(
...
# =============================================================================
            html.Br(),
            dbc.Label("依關聯節度篩選鏈結", style=bold_orange),
            # 網路圖篩選節點閥值slider
            dcc.Slider(
            ...
            dbc.Label("連結強度計算方式", style=bold_orange),
            #計算方式選鈕
            dcc.RadioItems(
...
#             #pd.concat(table_data,pd.DataFrame({'Date': i,
#                                #'id': j,
#                                #'Recent': k,
#                                #}))
